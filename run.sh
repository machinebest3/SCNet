...
python -u main.py --data_root ../datasets --dataset cifar10  --lr 0.02 --lamb 170 --tau 0.8 --r 0.6 --noise_type sym
...
python -u main.py --data_root ../datasets --dataset cifar10  --lr 0.02 --lamb 4.0 --tau 0.4 --r 0.2 --noise_type sym --type gce --beta 0.6 --mix_up 1
...
### sym noise ratio = 80%
python -u main.py --data_root ../datasets --dataset cifar10  --lr 0.02 --lamb 4.0 --tau 0.8 --r 0.8 --noise_type sym --type gce --beta 0.8 --mix_up 1
